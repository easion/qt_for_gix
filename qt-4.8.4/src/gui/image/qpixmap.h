...
#if defined(Q_WS_GIX)
	gi_image_t *toGixNativeImage(gi_image_t *orig = NULL) const;
	static QPixmap CopyGixNativeImage(gi_image_t *, bool auto_free=false);
	static QPixmap CopyGixNativePixmap(gi_window_id_t );
	static QPixmap RefGixNativeImage(gi_image_t *);
...
#if defined(Q_WS_X11) || defined(Q_WS_QWS)|| defined(Q_WS_GIX)
