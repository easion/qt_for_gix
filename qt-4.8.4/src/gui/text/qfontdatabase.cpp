...
struct QtFontStyle
{
    ...
    ~QtFontStyle() {
        ...
        delete [] setwidthName;
#endif
#if defined(Q_WS_X11) || defined(Q_WS_QWS) || defined(Q_WS_QPA) || defined(Q_OS_SYMBIAN) ||  defined(Q_WS_GIX)
        while (count) {
...
#endif // Q_WS_X11
#if defined(Q_WS_QWS) || defined(Q_WS_QPA) || defined(Q_OS_SYMBIAN)  || defined(Q_WS_GIX)
    bool antialiased;
#endif
...
#if defined(Q_WS_X11) || defined(Q_WS_QWS) || defined(Q_WS_QPA) || defined(Q_WS_GIX)
...
#if defined(Q_WS_X11) || defined(Q_WS_WIN)|| defined(Q_WS_GIX) || defined(Q_OS_SYMBIAN) || defined(Q_WS_QPA)
