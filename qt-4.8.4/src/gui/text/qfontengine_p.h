...
#if !defined(Q_WS_X11)&& !defined(Q_WS_GIX) && !defined(Q_WS_WIN) && !defined(Q_WS_MAC) && !defined(Q_OS_SYMBIAN) && !defined(Q_WS_QPA)
...
#if defined(Q_WS_WIN) || defined(Q_WS_X11)|| defined(Q_WS_GIX)  || defined(Q_WS_QWS) || defined(Q_WS_QPA) || defined(Q_OS_SYMBIAN)
    struct KernPair {
        uint left_right;
        QFixed adjust;
