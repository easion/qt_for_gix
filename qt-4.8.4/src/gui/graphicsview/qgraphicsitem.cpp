...
#if !defined(QT_NO_IM) && (defined(Q_WS_X11) || defined(Q_WS_QWS)|| defined(Q_WS_GIX) || defined(Q_OS_SYMBIAN))
...
{
#if !defined(QT_NO_IM) && (defined(Q_WS_X11)|| defined(Q_WS_GIX) || defined(Q_WS_QWS) || defined(Q_OS_SYMBIAN))
