...
typedef bool(*QX11FilterFunction)(gi_msg_t *event);
Q_GUI_EXPORT void qt_installpfEventFilter(QX11FilterFunction func);

static bool x11EventFilter(gi_msg_t *event);

QMeeGoGraphicsSystemSwitchHandler::QMeeGoGraphicsSystemSwitchHandler()
{
    qt_installpfEventFilter(x11EventFilter);
}
...
bool x11EventFilter(gi_msg_t *event)
{
