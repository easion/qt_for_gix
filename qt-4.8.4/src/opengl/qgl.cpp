...
#if defined(Q_WS_X11)|| defined(Q_WS_GIX) || defined(Q_WS_MAC) || defined(Q_WS_QWS) || defined(Q_WS_QPA) || defined(Q_OS_SYMBIAN)
...
#if defined(Q_WS_X11) || defined(Q_WS_GIX) || defined(Q_WS_MAC) || defined(Q_WS_GIX) || defined(Q_WS_QWS) || defined(Q_WS_QPA)
