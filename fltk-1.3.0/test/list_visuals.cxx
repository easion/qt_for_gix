//
// "$Id: list_visuals.cxx 8033 2010-12-15 12:11:16Z AlbrechtS $"
//
...
static void print_mask(gi_screen_info_t* p) {
  int n = 0;
  int what = 0;
...
void list_visuals() {
  ...
  Atom overlayVisualsAtom = gi_intern_atom("SERVER_OVERLAY_VISUALS",1);
  ...
  if (XmbufQueryExtension(fl_display,&event_base, &error_base)) {
    XmbufGetScreenInfo(fl_display,GI_DESKTOP_WINDOW_ID,
  ...
  for (int i=0; i<num; i++) {
    gi_screen_info_t *p = visualList+i;
...
//
// End of "$Id: list_visuals.cxx 8033 2010-12-15 12:11:16Z AlbrechtS $".
//
